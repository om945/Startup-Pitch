  ...
  return (
    <div className='w-[25rem] mx-auto bg-signin flex flex-col justify-center items-center py-[1.5rem] px-[2.5rem] mb-[2rem] mt-[7rem] shadow-lg rounded-2xl border-border border-[1px]'>
      ...
      <div className='flex w-full flex-col items-center'>
        <h2 className='font-Bold text-txt-black text-[1.4rem]'>Join NextMove Now!</h2>
        <p className='font-Regular text-txt-gray-black text-[1.1rem] text-center mt-[0.3rem]'>Sign Up as a Founder or Investor</p>
        <div className='flex w-full gap-[0.8rem]'>
          <button
            className='flex w-full justify-center items-center mt-[1.5rem] font-Regular text-txt-gray-black border-border border-[1px] py-[0.5rem] rounded-xl cursor-pointer hover:border-txt-black focus:bg-btn-blue focus:text-nav-white focus:border-btn-blue'
        ...
        <button className='flex w-full justify-center items-center mt-[1.5rem] font-Regular text-txt-gray-black border-border border-[1px] py-[0.5rem] rounded-xl cursor-pointer'>
          <img src={googleImg} alt="google-logo" className='w-[1.4rem] mr-[0.5rem]' />
          Continue with Google
        </button>
        <hr className='w-full mt-[2rem] text-border' />
        <span className='font-Regular text-[1.1rem] text-txt-gray-black bg-signin mt-[-0.9rem] px-[0.5rem]'>or</span>
        <form onSubmit={handleLogIn} className='w-full flex flex-col justify-center items-center'>
          ...
          <div className='flex flex-col items-start w-full font-Regular mt-[1rem]'>
            ...
            <input type="password" placeholder='Enter your last name' className='border-border w-full border-[1px] mt-[0.5rem] rounded-lg px-[0.8rem] py-[0.5rem] outline-txt-gray-black-black' />
          </div>
          <div className='flex flex-col items-start w-full font-Regular mt-[1rem]'>
